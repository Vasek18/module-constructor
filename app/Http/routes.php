...
Route::get('my-modules/bitrix/{id}/events_handlers', 'Modules\BitrixController@events_handlers'); // привязка к событиям
...
Route::get('my-modules/bitrix/{id}/components', 'Modules\BitrixController@components'); // компоненты
