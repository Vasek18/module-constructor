...
@section('page')
    ...
    <hr>
    <p class="description">Здесь задаются настройки, которые можно будет получить на сайте через . Сами значения задаются на странице настроек модуля (Настройки -> Настройки модулей -> Название модуля).</p>
@stop