    ...
    <form method="post" action="{{ action('Modules\Bitrix\BitrixDataStorageController@store_ib', $module->id) }}">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <a href="#seo" aria-controls="seo" role="tab"
                   data-toggle="tab">{{ trans('bitrix_iblocks_form.tab_seo_title') }}</a>
            </li>
            <li role="presentation">
                <a href="#fields" aria-controls="fields" role="tab"
            ...
            <li role="presentation">
                <a href="#sections_fields" aria-controls="sections_fields" role="tab"
                   data-toggle="tab">{{ trans('bitrix_iblocks_form.tab_section_fields_title') }}</a>
            </li>
            <li role="presentation">
                <a href="#shop_catalog" aria-controls="shop_catalog" role="tab"
            ...
            <li role="presentation">
                <a href="#captions" aria-controls="captions" role="tab"
                   data-toggle="tab">{{ trans('bitrix_iblocks_form.tab_captions_title') }}</a>
            </li>
            <li role="presentation">
                <a href="#event_log" aria-controls="event_log" role="tab"
