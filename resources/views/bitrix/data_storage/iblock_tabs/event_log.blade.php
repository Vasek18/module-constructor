<table class="table">
    <tr>
        ...
        <td>
            ...
            <label for="FIELDS[LOG_SECTION_ADD][IS_REQUIRED]" title=""></label>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            ...
            <label for="FIELDS[LOG_SECTION_EDIT][IS_REQUIRED]" title=""></label>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            ...
            <label for="FIELDS[LOG_SECTION_DELETE][IS_REQUIRED]" title=""></label>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            ...
            <label for="FIELDS[LOG_ELEMENT_ADD][IS_REQUIRED]" title=""></label>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            ...
            <label for="FIELDS[LOG_ELEMENT_EDIT][IS_REQUIRED]" title=""></label>
        </td>
    </tr>
    <tr>
        <th>
        ...
        <td>
            ...
            <label for="FIELDS[LOG_ELEMENT_DELETE][IS_REQUIRED]" title=""></label>
        </td>
    </tr>
</table>