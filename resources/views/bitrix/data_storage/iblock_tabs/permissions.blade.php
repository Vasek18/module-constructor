    ...
    <tr>
        ...
        <td>
            <select class="form-control" name="GROUP_ID" id="group_2">
                ...
                <option value="Array('2' => 'R')" {{$iblock && isset($iblock->params->GROUP_ID) && $iblock->params->GROUP_ID == "Array('2' => 'R')" ? 'selected' : ''}}  {{!$iblock || !isset($iblock->params->GROUP_ID) ? 'selected' : ''}}>Чтение</option>
