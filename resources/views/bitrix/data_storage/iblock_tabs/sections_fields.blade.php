    ...
    <tr>
        ...
        <td>
            <div>
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WIDTH]"
                     >
                    Максимальная ширина:&nbsp;
                    <input name="FIELDS[SECTION_PICTURE][DEFAULT_VALUE][WIDTH]" type="text" value="" size="7">
                </div>
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][HEIGHT]"
                     >
                    Максимальная высота:&nbsp;
                    <input name="FIELDS[SECTION_PICTURE][DEFAULT_VALUE][HEIGHT]" type="text" value="" size="7">
                </div>
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][IGNORE_ERRORS_DIV]"
                     >
                    <div>
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][METHOD_DIV]"
                     >
                    <div>
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][COMPRESSION]"
                     >
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][USE_WATERMARK_FILE]"
                     >
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_FILE_ALPHA]"
                     >
                    Прозрачность авторского знака (%):&nbsp;
                    <input name="FIELDS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_FILE_ALPHA]" type="text" value=""
                           size="3">
                </div>
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_FILE_POSITION]"
                     >
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][USE_WATERMARK_TEXT]"
                     >
                    Содержание надписи:&nbsp;
                    <input name="FIELDS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT]" type="text" value="" size="35">
                </div>
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_FONT]"
                     >
                    Путь к файлу шрифта:&nbsp;
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_COLOR]"
                     >
                    ...
                    <input type="button" value="..."
                            >
<span id="bx_colorpicker_TfqxLXgJd1"><div>
        <img src="/bitrix/images/1.gif" title="TfqxLXgJd1"
             id="bx_btn_tfqxlxgjd1">
                ...
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_SIZE]"
                     >
                    Размер (% от размера картинки):&nbsp;
                    <input name="FIELDS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_SIZE]" type="text" value=""
                           size="3">
                </div>
                <div id="SETTINGS[SECTION_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_POSITION]"
                     >
                    Размещение авторского знака:&nbsp;
    ...
    <tr>
        ...
        <td>
            <textarea class="form-control" name="FIELDS[SECTION_DESCRIPTION][DEFAULT_VALUE]" rows="5" cols="47"></textarea>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <div>
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WIDTH]"
                     >
                    Максимальная ширина:&nbsp;
                    <input name="FIELDS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WIDTH]" type="text" value="" size="7">
                </div>
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][HEIGHT]"
                     >
                    Максимальная высота:&nbsp;
                    <input name="FIELDS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][HEIGHT]" type="text" value="" size="7">
                </div>
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][IGNORE_ERRORS_DIV]"
                     >
                    <div>
                        <input type="checkbox" value="Y"
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][METHOD_DIV]"
                     >
                    <div>
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][COMPRESSION]"
                     >
                    Качество (только для JPEG, 1-100, по умолчанию около 75):&nbsp;
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][USE_WATERMARK_FILE]"
                     >
                    Путь к изображению с авторским знаком:&nbsp;
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_FILE_ALPHA]"
                     >
                    Прозрачность авторского знака (%):&nbsp;
                    <input name="FIELDS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_FILE_ALPHA]" type="text"
                           value="" size="3">
                </div>
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_FILE_POSITION]"
                     >
                    Размещение авторского знака:&nbsp;
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][USE_WATERMARK_TEXT]"
                     >
                    Содержание надписи:&nbsp;
                    <input name="FIELDS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT]" type="text" value=""
                           size="35">
                </div>
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_FONT]"
                     >
                    Путь к файлу шрифта:&nbsp;
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_COLOR]"
                     >
                    Цвет надписи (без #, например, FF00EE):&nbsp;
                    ...
                    <input type="button" value="..."
                            >
<span id="bx_colorpicker_NdwuRgfY9A"><div>
        <img src="/bitrix/images/1.gif" title="NdwuRgfY9A"
             id="bx_btn_ndwurgfy9a">
                ...
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_SIZE]"
                     >
                    Размер (% от размера картинки):&nbsp;
                    <input name="FIELDS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_SIZE]" type="text"
                           value="" size="3">
                </div>
                <div id="SETTINGS[SECTION_DETAIL_PICTURE][DEFAULT_VALUE][WATERMARK_TEXT_POSITION]"
                     >
                    Размещение авторского знака:&nbsp;
                    <select class="form-control"
    ...
    <tr>
        ...
        <td>
            <div>
                ...
                <div id="SETTINGS[SECTION_CODE][DEFAULT_VALUE][TRANS_LEN]"
                     >
                ...
                <div id="SETTINGS[SECTION_CODE][DEFAULT_VALUE][TRANS_CASE]"
                     >
                ...
                <div id="SETTINGS[SECTION_CODE][DEFAULT_VALUE][USE_GOOGLE]"
                     >
                    <div>
