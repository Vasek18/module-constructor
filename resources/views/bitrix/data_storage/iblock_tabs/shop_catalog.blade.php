        ...
        <td>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="OF_NEW_IBLOCK_TYPE_ID" id="OF_NEW_IBLOCK_TYPE_ID"
                               value=""
                               disabled="disabled">
                    </td>
                </tr>
            </table>
            <b>Свойства инфоблока торговых предложений</b>
            <table id="of_prop_list">
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="OF_PROPERTY_n0_PROPERTY_TYPE"
                                id="OF_PROPERTY_n0_PROPERTY_TYPE"
                                >
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="OF_PROPERTY_n1_PROPERTY_TYPE"
                                id="OF_PROPERTY_n1_PROPERTY_TYPE"
                                >
                            <optgroup label="Базовые типы">
                                <option value="S" selected="">Строка</option>
                                <option value="N">Число</option>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="OF_PROPERTY_n2_PROPERTY_TYPE"
                                id="OF_PROPERTY_n2_PROPERTY_TYPE"
                                >
                            <optgroup label="Базовые типы">
                                <option value="S" selected="">Строка</option>
                                <option value="N">Число</option>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="OF_PROPERTY_n3_PROPERTY_TYPE"
                                id="OF_PROPERTY_n3_PROPERTY_TYPE"
                                >
                            <optgroup label="Базовые типы">
                                <option value="S" selected="">Строка</option>
                                <option value="N">Число</option>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="OF_PROPERTY_n4_PROPERTY_TYPE"
                                id="OF_PROPERTY_n4_PROPERTY_TYPE"
                                >
                            <optgroup label="Базовые типы">
                                <option value="S" selected="">Строка</option>
                                <option value="N">Число</option>
