...
@section('h1')
    Создание почтового шаблона | Почтовое событие {{ $mail_event->name }} ({{ $mail_event->code }})
@stop
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="name" name="name"
                       value="" required aria-describedby="name_help">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="from" name="from"
                       value="#DEFAULT_EMAIL_FROM#" required aria-describedby="from_help">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="to" name="to"
                       value="#EMAIL_TO#" required aria-describedby="to_help">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="copy" name="copy"
                       value=""  aria-describedby="copy_help">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="hidden_copy" name="hidden_copy"
                       value=""  aria-describedby="hidden_copy_help">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="reply_to" name="reply_to"
                       value=""  aria-describedby="reply_to_help">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="in_reply_to" name="in_reply_to"
                       value=""  aria-describedby="in_reply_to_help">
                <span class="help-block" id="in_reply_to_help"></span>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-12">
                <textarea name="body" id="" class="form-control" rows="20"></textarea>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-12">
