    ...
    <div class="container">
        <div class="row">
            ...
            <div class="banner-on-main col-md-8 col-md-offset-2">
                ...
                <p>Не, серьёзно, это же совсем не сложно теперь. Просто заполняй простые формочки в сервисе, читай подсказки и на выходе получишь готовый для публикации в Marketplace архив с модулем.</p>
            </div>
