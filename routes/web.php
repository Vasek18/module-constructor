...
Route::group([
    ...
    Route::group(['prefix' => '{module}/admin_options'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_admin_options',
            'uses' => 'Modules\Bitrix\BitrixOptionsController@index'
        ]);
    ...
    Route::group(['prefix' => '{module}/events_handlers'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_events_handlers',
            'uses' => 'Modules\Bitrix\BitrixEventHandlersController@index'
        ]);
    ...
    Route::group(['prefix' => '{module}/components'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_components',
            'uses' => 'Modules\Bitrix\BitrixComponentsController@index'
        ]);
        Route::get('create', [
            'as'   => 'bitrix_new_component',
            'uses' => 'Modules\Bitrix\BitrixComponentsController@create'
        ]);
        ...
        Route::get('{component}', [
            'as'   => 'bitrix_component_detail',
            'uses' => 'Modules\Bitrix\BitrixComponentsController@show'
        ]);
        Route::post('upload_component_zip', [
            'as'   => 'upload_component_zip',
            'uses' => 'Modules\Bitrix\BitrixComponentsController@upload_zip'
        ]);
        ...
        Route::group(['prefix' => '{component}/visual_path'], function(){
            Route::get('', [
                'as'   => 'bitrix_component_visual_path',
                'uses' => 'Modules\Bitrix\BitrixComponentsController@show_visual_path'
            ]);
        ...
        Route::group(['prefix' => '{component}/params'], function(){
            Route::get('', [
                'as'   => 'bitrix_component_params',
                'uses' => 'Modules\Bitrix\BitrixComponentsParamsController@index'
            ]);
        ...
        Route::group(['prefix' => '{component}/component_php'], function(){
            Route::get('', [
                'as'   => 'bitrix_component_component_php',
                'uses' => 'Modules\Bitrix\BitrixComponentsController@show_component_php'
            ]);
        ...
        Route::group(['prefix' => '{component}/other_files'], function(){
            Route::get('', [
                'as'   => 'bitrix_component_other_files',
                'uses' => 'Modules\Bitrix\BitrixComponentsArbitraryFilesController@index'
            ]);
        ...
        Route::group(['prefix' => '{component}/templates'], function(){
            Route::get('', [
                'as'   => 'bitrix_component_templates',
                'uses' => 'Modules\Bitrix\BitrixComponentsTemplatesController@index'
            ]);
    ...
    Route::group(['prefix' => '{module}/data_storage'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_data_storage',
            'uses' => 'Modules\Bitrix\BitrixDataStorageController@index'
        ]);
    ...
    Route::group(['prefix' => '{module}/arbitrary_files'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_arbitrary_files',
            'uses' => 'Modules\Bitrix\BitrixArbitraryFilesController@index'
        ]);
    ...
    Route::group(['prefix' => '{module}/mail_events'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_mail_events',
            'uses' => 'Modules\Bitrix\BitrixMailEventsController@index'
        ]);
    ...
    Route::group(['prefix' => '{module}/admin_menu'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_admin_menu',
            'uses' => 'Modules\Bitrix\BitrixAdminMenuController@index'
        ]);
    ...
    Route::group(['prefix' => '{module}/lang'], function(){
        Route::get('', [
            'as'   => 'bitrix_module_lang',
            'uses' => 'Modules\Bitrix\BitrixLangController@index'
        ]);
...
Route::group(['prefix' => 'project_help'], function(){
    ...
    Route::group(['prefix' => 'bitrix'], function(){
        ...
        Route::group(['prefix' => 'class_php_templates'], function(){
            Route::post('add', [
                'uses'       => 'ProjectHelpController@bitrixClassPhpTemplatesAdd',
                'middleware' => ['auth']
            ]);
            Route::get('{template}/delete', [
                'uses'       => 'ProjectHelpController@bitrixClassPhpTemplatesDelete',
                'middleware' => ['auth']
            ]);
        });
    });
