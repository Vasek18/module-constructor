...
Class aristov_test extends CModule{
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("ARISTOV_TEST_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("ARISTOV_TEST_MODULE_DESC");
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("ARISTOV_TEST_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("ARISTOV_TEST_INSTALL"), $this->GetPath()."/install/step.php");
	}
